...
const navigationItems = [
  { label: "Anasayfa", icon: "/figmaAssets/component-8.svg", active: true },
  { label: "Öğren", icon: "/figmaAssets/component-8-1.svg", active: false },
  { label: "Dönüştür", icon: "/figmaAssets/component-8-2.svg", active: false },
  { label: "Profil", icon: "/figmaAssets/component-8-3.svg", active: false },
];
